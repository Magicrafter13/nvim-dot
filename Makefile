...
all: directories nvim/lua/plug-set/settings.make nvim/init.lua nvim/lua/clipboard.lua nvim/lua/colorscheme.lua nvim/lua/plug-set/init.lua nvim/lua/lazy-init.lua
...
.PHONY: directories all clean uninstall #clean-partial

nvim/lua/plug-set/settings.make nvim/lua/plug-set/lsp.make: config.json .plugins
	@main/makefiles.py
	@$(MAKE) -s -f nvim/lua/plug-set/settings.make
	@$(MAKE) -s -f nvim/lua/plug-set/lsp.make
...
nvim/lua/colorscheme.lua: config.json .plugins plugins.json
	@main/colorscheme.py
